...
namespace Whoop
{
    public partial class ActivityIdMappingClient
    {
        ...
        partial void PrepareGetActivityMappingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long activityV1Id);
        partial void ProcessGetActivityMappingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetActivityMappingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Whoop.ActivityIdMappingResponse> GetActivityMappingAsync(
            long activityV1Id,
            global::Whoop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetActivityMappingAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Whoop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Whoop.AutoSDKHttpResponse<global::Whoop.ActivityIdMappingResponse>> GetActivityMappingAsResponseAsync(
            long activityV1Id,
            global::Whoop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetActivityMappingArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Whoop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Whoop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetActivityMappingAsync",
                                pathTemplate: "$\"/v1/activity-mapping/{activityV1Id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetActivityMappingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Whoop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetActivityMappingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Whoop.ActivityIdMappingResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Whoop.AutoSDKHttpResponse<global::Whoop.ActivityIdMappingResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Whoop.ActivityIdMappingResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
