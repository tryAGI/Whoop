...
namespace Whoop
{
    public partial class UserClient
    {
        ...
        partial void ProcessGetProfileBasicResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProfileBasicResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Whoop.UserBasicProfile> GetProfileBasicAsync(
            global::Whoop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetProfileBasicAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Whoop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Whoop.AutoSDKHttpResponse<global::Whoop.UserBasicProfile>> GetProfileBasicAsResponseAsync(
            global::Whoop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Whoop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Whoop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProfileBasicAsync",
                                pathTemplate: "\"/v2/user/profile/basic\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProfileBasicResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Whoop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProfileBasicResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Whoop.UserBasicProfile.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Whoop.AutoSDKHttpResponse<global::Whoop.UserBasicProfile>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Whoop.UserBasicProfile.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
