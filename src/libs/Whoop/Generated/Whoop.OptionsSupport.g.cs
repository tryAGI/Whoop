...
namespace Whoop
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Whoop.AutoSDKRetryOptions Retry { get; set; } = new global::Whoop.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Whoop.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Whoop.IAutoSDKHook>();
        ...
        public global::Whoop.AutoSDKClientOptions AddHook(
            global::Whoop.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Whoop.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Whoop.AutoSDKClientOptions UseAuthorizationProvider(
            global::Whoop.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Whoop.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Whoop.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Whoop.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Whoop.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Whoop.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Whoop.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Whoop.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Whoop.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Whoop.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Whoop.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Whoop.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Whoop.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Whoop.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Whoop.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Whoop.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Whoop.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Whoop.AutoSDKClientOptions clientOptions,
            global::Whoop.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Whoop.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Whoop.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Whoop.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Whoop.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Whoop.IAutoSDKHook, global::Whoop.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Whoop.AutoSDKHookContext context)
        {
