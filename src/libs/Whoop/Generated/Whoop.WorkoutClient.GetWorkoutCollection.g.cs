...
namespace Whoop
{
    public partial class WorkoutClient
    {
        ...
        partial void PrepareGetWorkoutCollectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? nextToken);
        partial void ProcessGetWorkoutCollectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWorkoutCollectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Whoop.WorkoutCollection> GetWorkoutCollectionAsync(
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWorkoutCollectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Whoop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Whoop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetWorkoutCollectionAsync",
                                pathTemplate: "\"/v2/activity/workout\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWorkoutCollectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Whoop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWorkoutCollectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
