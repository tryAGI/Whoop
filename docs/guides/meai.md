...
The Whoop SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Whoop
```
...
using var client = new WhoopClient(
    apiKey: Environment.GetEnvironmentVariable("WHOOP_API_KEY")!);
